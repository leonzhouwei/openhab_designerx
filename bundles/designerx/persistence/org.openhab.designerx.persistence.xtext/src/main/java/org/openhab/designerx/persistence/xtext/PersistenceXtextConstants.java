package org.openhab.designerx.persistence.xtext;

import org.openhab.designerx.model.ModelConstants;

public final class PersistenceXtextConstants {
	// System
	...
	public static final String OPENHAB_SITEMAPS_DIR_RELATIVE_PATH = ModelConstants.FILE_SEPARATOR + OPENHAB_CONFIG_DIR_BASE_NAME + FILE_SEPARATOR + OPENHAB_SITEMAPS_DIR_BASE_NAME;
	public static final String OPENHAB_TRANSFORM_DIR_BASE_NAME = "transform";
	public static final String OPENHAB_ITEMS_DIR_RELATIVE_PATH = ModelConstants.FILE_SEPARATOR + OPENHAB_CONFIG_DIR_BASE_NAME + FILE_SEPARATOR + OPENHAB_ITEMS_DIR_BASE_NAME;
	public static final String SITEMAP = "sitemap";
	public static final String SITEMAP_FILE_EXTENSION = ".sitemap";
	
	// DesignerFX
	
	private PersistenceXtextConstants() {}
